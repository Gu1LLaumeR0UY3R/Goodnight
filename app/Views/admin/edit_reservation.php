        ...
        <form action="/admin/editReservation/<?php echo htmlspecialchars($reservation["id_reservation"]); ?>" method="POST">
            ...
            <select id="id_tarif" name="id_tarif" required>
                ...
                <?php foreach ($tarifs as $tarif): ?>
                    <option value="<?php echo htmlspecialchars($tarif['id_tarif']); ?>" <?php echo ($tarif['id_tarif'] == $reservation['id_tarif']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($tarif['prix_semaine'] . ' €/jour (Saison ' . $tarif['id_saison'] . ', Année ' . $tarif['annee'] . ')'); ?></option>
                <?php endforeach; ?>
            </select>
