...
<head>
    ...
    <title>Modifier une Réservation - Admin</title>
...
<body>
    ...
    <main>
        ...
        <form action="/admin/editReservation/<?php echo htmlspecialchars($reservation["id_reservation"]); ?>" method="POST">
            <label for="id_biens">Bien :</label>
            <select id="id_biens" name="id_biens" required>
                <option value="">Sélectionnez un bien</option>
                <?php foreach ($biens as $bien): ?>
                    <option value="<?php echo htmlspecialchars($bien['id_biens']); ?>" <?php echo ($bien['id_biens'] == $reservation['id_biens']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($bien['designation_bien']); ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <select id="id_locataire" name="id_locataire" required>
                ...
                <?php foreach ($users as $user): ?>
                    <option value="<?php echo htmlspecialchars($user['id_locataire']); ?>" <?php echo ($user['id_locataire'] == $reservation['id_locataire']) ? 'selected' : ''; ?>>
            ...
            <select id="id_tarif" name="id_tarif" required>
                ...
                <?php foreach ($tarifs as $tarif): ?>
                    <option value="<?php echo htmlspecialchars($tarif['id_tarif']); ?>" <?php echo ($tarif['id_tarif'] == $reservation['id_tarif']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($tarif['prix_semaine'] . ' €/semaine (Saison ' . $tarif['id_saison'] . ', Année ' . $tarif['annee'] . ')'); ?></option>
                <?php endforeach; ?>
            </select>

            <button type="submit">Mettre à jour la réservation</button>
        </form>
